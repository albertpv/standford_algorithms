...
result = countComparisonsWithFirst(numList)
#####################################################################
# Read the contents of the file into a Python list
NUMLIST_FILENAME = "QuickSort.txt"
inFile = open(NUMLIST_FILENAME, 'r')
...
with inFile as f: numList = [int(integers.strip()) for integers in f.readlines()]
# call functions to count comparisons
result = countComparisonsWithLast(numList)
...
print "Number of sorts with pivot first element", count_pivot_first
print "Number of sorts with pivot last element" , count_pivot_last
print "Number of sorts with pivot median element", count_pivot_median